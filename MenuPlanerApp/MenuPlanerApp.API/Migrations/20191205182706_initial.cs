        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 60, nullable: false),
                    Description = table.Column<string>(maxLength: 100, nullable: true),
                    DirectionPictures = table.Column<byte[]>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WantsUserToFilterFructose = table.Column<bool>(nullable: false),
                    WantsUserToFilterHistamin = table.Column<bool>(nullable: false),
                    WantsUserToFilterLactose = table.Column<bool>(nullable: false),
                    WantsUserToFilterCeliac = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
